 ...
 * Asteroids, ship, bullets.
 * The structure seems like slight overkill for bullets but it keeps the code generic,
 * and the use of vertexListLength means there isn't any actual speed overhead.
 * Also if we wanted line, triangle or even spinning bullets the code wouldn't need to change.
 */
public class CollisionPackage {

    // All the members are public to avoid multiple calls to getters and setters.
    ...
    // This next float will be used to detect if the circle shaped hitboxes collide.
    // It represents the furthest point from the centre of any given object.
