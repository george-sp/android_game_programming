...
/**
 * Manages the GL.
 * Creates a GL program that can be accessed by the application
 * via its handle and the getProgram().
 */
public class GLManager {

    // Some constants to help count the number of bytes between elements of our vertex data arrays.
    ...
    // A very simple vertexShader that we can define with a String.
