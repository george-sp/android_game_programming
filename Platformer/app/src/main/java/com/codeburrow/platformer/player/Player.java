...
import com.codeburrow.platformer.game_engine.RectHitbox;
import com.codeburrow.platformer.game_engine.SoundManager;
...
public class Player extends GameObject {
    ...
    public boolean pullTrigger() {
        return machineGun.shoot(this.getWorldLocation().x, this.getWorldLocation().y, getFacing(), getHeight());
    }
